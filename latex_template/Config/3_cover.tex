...
%         You may use "\\" to force line breaks
\nttitle(sub,en){Cows Wireless Tracking}%
\nttitle(sub,pt){Rastreamento de Vacas}%
...
% Co-advisers(s)
\ntaddperson{adviser}(c,m){João Nuno de Oliveira e Silva, Assistant Professor, University Lisbon}
